...
ACCESS_TOKEN = '1446849911128002568-lUdNSTMxq3Vd4Effysxq5a4qKJUg5e'     # your access token
ACCESS_SECRET = 'otFQznn8uL1WBvVkhpN2lVBURyPaKlTYR2vdD5cMSvHUb'    # your access token secret
CONSUMER_KEY = 'QPIJexkyAch6iQBx1oLqzzEUz'     # your API key
CONSUMER_SECRET = 'n7qwfRq29MVQZsbmNNlN30RoFJKPPNVCA3cvWxWCyUIwo9gOXf'  # your API secret key

# the tags to track
tags = ['#', 'facebook', 'meta', 'amazon', 'apple', 'tesla', 'google', 'microsoft']
